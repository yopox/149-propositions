var propositions = [
    ...
    "PROPOSITION SL3.11 : Sensibiliser à l’importance et l’intérêt de la ville plus compacte, et construire une nouvelle culture de l’habitat collectif.",
    "PROPOSITION SL3.12 : Financer les rénovations des logements dans les petites communes.",
    "PROPOSITION SL3.13 : Rendre les centres plus attractifs par la revitalisation des commerces et le maintien des écoles en milieu rural.",
    ...
    "PROPOSITION RC1 : Renforcer le contrôle des politiques environnementales, en créant, notamment un «Défenseur de l’environnement» à l'image du Défenseur des droits.",
    "PROPOSITION RC2 : Réforme du Conseil Économique, Social et Environnemental.",
    "PROPOSITION RC3 : Modifier le préambule de la Constitution pour y ajouter : « « La conciliation des droits, libertés et principes qui en résultent ne saurait compromettre la préservation de l'environnement, patrimoine commun de l'humanité. »",
    "PROPOSITION RC4 : Modifier l'article premier de la Constitution pour y ajouter : « La République garantit la préservation de la biodiversité, de l'environnement et lutte contre le dérèglement climatique »."
]